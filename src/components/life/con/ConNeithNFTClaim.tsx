...
const ConNeithNFTClaim = () => {
  const { t } = useTranslation("life");
  const claimList = t("neithStationTab.claim.list", { returnObjects: true });

  return (
    <div className={cn("life-neith-section claim-section-wrap")}>
      <div className={cn("life-neith-section-inner life-neith-claim-wrap")}>
...
export default ConNeithNFTClaim;
