  ...
  return (
    <div className={cn('governance-setting-type-wrap', more && 'more', isOpen && 'open')}>
      ...
      <div className={cn('check-content-wrap')} ref={contentRef}>
        {/* 23.04.10 수정: 280대응 테이블wrap 추가 */}
        <div className={cn('proposal-table-wrap first-cell-fix')}>
        ...
        {/* 23.04.10 수정: 280대응 테이블wrap 추가 */}
        <div className={cn('detail-table-wrap first-cell-fix')}>
          <table className={cn('detail-table')}>
            ...
            <tbody>
              ...
              <tr className={cn('dark-line')}>
                <th rowSpan={2}>{t('governanceSet.detail.title.period') /* 투표기간 */}</th>
