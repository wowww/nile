...
import DaoIndividualHomeDiscuss from '@/components/dao/individualHome/DaoIndividualHomeDiscuss';
    ...
    <DaoBoxLayout>
      <DaoBox className="dao-home-type">
        <div className={cn('community-box-wrap')}>
          <DaoBoxTitle title={'Proposals'} titleHref="/dao/governance?tab=proposal" />
          {agoraData.length > 0 ? (
        ...
        <div className={cn('community-box-wrap')}>
          <DaoBoxTitle title={'Discussions'} titleHref="/dao/governance?tab=discussions" />
