...
import { DaoBox, DaoBoxLayout } from '../DaoBoxLayout';
...
import { DataProps, ScanFromToCell } from '@/components/dao/scan/ScanFromToCell';
...
const DaoIndividualHomeToken = () => {
  ...
  const daoUrlRoot = `/dao/${activeDao.value}`;
    ...
    <DaoBoxLayout className="half">
      ...
      <DaoBox className="dao-common-card">
        <h4 className={cn('card-title')}>
          <TextButton buttonText="Obelisk" iconValue="arrow-xl" size="xl" href="/dao/obelisk" />
        </h4>
