...
const StationCompleteTop = () => {
  ...
  return (
    ...
    <DaoBoxTitle title={t('station.complete.title')} desc={t('station.complete.desc', { type: useDaoCharacterConvert(activeDao.value), unit: t(`amountUnit.${activeDao.value}.unit1`) })} type="img">
