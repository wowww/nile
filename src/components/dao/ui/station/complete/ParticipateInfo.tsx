...
import StationTitle from '../recruit/StationTitle';
    ...
    <div className={cn('participate-info-wrap')}>
      <div className={cn('check-item-wrap', 'station-check')} id="recruitment-information">
        <div className={cn('check-item', 'recruit')}>
          <StationTitle title={t('station.participate.title')} />
            ...
            <ul className={cn('list-wrap')}>
              ...
              <li>
                <span className={cn('text-wrap')}>
                  ...
                  <span className={cn('value')}>
                    {/* 23.03.29 수정: WONDER 분배량 수정 */}
                    1,700,010<span className={cn('unit')}>{t('unit1', { ns: 'dao', keyPrefix: `amountUnit.${activeDao.value}` })}</span>
                  </span>
                </span>
              </li>
              <li>
              ...
              <ul>
                <li>
                  {t('station.participate.caution.4.1', {
                    ...
                    n1: '1,900,010',
                    /* 23.03.29 수정: Station 분배량 수정 */
                    n2: '1,700,010',
                    n3: '200,000',
                  })}
                </li>
                {/* 23.03.29 수정: Station 모집 목표액 수정 */}
